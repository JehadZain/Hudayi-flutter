...
import 'package:hudayi/ui/helper/AppTextStyles.dart';
import 'package:hudayi/ui/widgets/glowing_stars.dart';
import 'package:flutter/material.dart';

class AnimatedHeader extends StatefulWidget {
  const AnimatedHeader({Key? key, this.isWriting, this.focusNode, required this.height, required this.text}) : super(key: key);
