...
class SocialMedia extends StatelessWidget {
  Map socialMediaMap;
  SocialMedia({Key? key, required this.socialMediaMap}) : super(key: key);
          ...
          children: [
            if (socialMediaMap["phone"] != "")
              socialMedia(context, Icons.phone, onTap: () {
                var encoded = Uri.encodeFull("tel://${socialMediaMap['phone']}");
                launchUrl(
                  Uri.parse(encoded),
            ...
            if (socialMediaMap["whatsapp"] != "")
              socialMedia(context, Icons.wechat_sharp, image: "assets/images/whtsapp.png", onTap: () {
            ...
            if (socialMediaMap["instagram"] != "")
              socialMedia(context, Icons.check_box_outline_blank, image: "assets/images/instagram.png", onTap: () {
                var encoded = Uri.encodeFull("https://www.instagram.com/${socialMediaMap["instagram"]}");
                launchUrl(
                  Uri.parse(encoded),
                  mode: LaunchMode.externalApplication,
                );
            ...
            if (socialMediaMap["facebook"] != "")
              socialMedia(context, Icons.facebook, onTap: () {
                var encoded = Uri.encodeFull("https://www.facebook.com/${socialMediaMap["facebook"]}");
                launchUrl(
                  Uri.parse(encoded),
                  mode: LaunchMode.externalApplication,
                );
            ...
            if (socialMediaMap["email"] != "")
              socialMedia(context, Icons.mail_sharp, onTap: () {
                var encoded = Uri.encodeFull("mailTo://${socialMediaMap['email']}");
                launchUrl(
                  Uri.parse(encoded),
                  mode: LaunchMode.externalApplication,
                );
            ...
            if (socialMediaMap["location"] != "")
              socialMedia(context, Icons.location_on, onTap: () {
                var encoded = Uri.encodeFull("http://www.google.com/maps/place/${socialMediaMap["location"]}");
                launchUrl(
                  Uri.parse(encoded),
                  mode: LaunchMode.externalApplication,
                );
